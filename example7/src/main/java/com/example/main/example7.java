...
public class example7 {
    public static void main(String[] args) {
        ...
        if(null!=volksVehicle){
            System.out.println("Programming vehicle name from spring context :"+ volksVehicle.getName());
        }else{
            System.out.println("Programming vehicle name from spring context:"+ audiVehicle.getName());
        }
    }
}
